...
const Header = () => {
    ...
    return (
        <header className="h-16 bg-white border-b border-neutral-200 px-6 flex items-center justify-end gap-4">
            {/* Notifications Bell */}
            <Link
                to="/actions"
            ...
            <div className="relative" ref={dropdownRef}>
                ...
                >
                    <div className="flex items-center gap-3">
                        {/* User Avatar */}
                        <div className="w-8 h-8 rounded-full bg-teal-400/20 flex items-center justify-center ring-1 ring-teal-500/20">
                        ...
                        <div className="text-left">
                            ...
                            <div className="text-xs text-slate-500 leading-tight">{userRole}</div>
                        </div>
                    </div>
                    <Icon
                        name="chevron_down"
