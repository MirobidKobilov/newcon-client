...
const Users = () => {
    ...
    const RoleBadge = ({ role }) => (
        <div className='inline-block px-2 sm:px-3 py-0.5 sm:py-1 rounded-lg bg-blue-100 text-blue-700'>
            <span className='text-[10px] sm:text-xs font-semibold'>{role}</span>
        </div>
    )
                                                ...
                                                <div className='flex flex-wrap gap-1'>
                                                    {user.roles && user.roles.length > 0 ? (
                                                        user.roles.map((role, index) => (
                                                            <span
                                                                key={index}
                                                                className='inline-block px-2 py-1 text-xs rounded bg-blue-100 text-blue-700 font-semibold'
                                                            >
                                                                {role}
                                                            </span>
                                                        ))
