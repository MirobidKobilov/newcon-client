...
const Products = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        let response
        if (isEditMode) {
            response = await api('put', formData, `/products/update/${editingItemId}`)
        } else {
            response = await api('post', formData, '/products/create')
        }
